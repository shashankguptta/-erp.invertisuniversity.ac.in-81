    ...
    (function() {
        ...
        google.load = function(a, b, c) {
            ...
            if (a = H[":" + e]) {
                ...
                f.match(/^[[\]A-Za-z0-9._]+$/) && (f = window.eval(f),
                c.callback = f));
        ...
        google.ca = function(a, b) {
            b ? (0 == J.length && (K(window, "load", L),
            !z("msie") && !z("safari") && !z("konqueror") && z("mozilla") || window.opera ? window.addEventListener("DOMContentLoaded", L, !1) : z("msie") ? document.write("<script defer onreadystatechange='google.loader.domReady()' src=//:>\x3c/script>") : (z("safari") || z("konqueror")) && window.setTimeout(M, 10)),
            J.push(a)) : K(window, "load", a)
        }
        ;
        ...
        google.loader.f = function(a, b, c) {
            if (c) {
                if ("script" == a) {
                    ...
                    "css" == a && (d = document.createElement("link"),
                    d.type = "text/css",
                    d.href = b,
                    d.rel = "stylesheet");
                ...
                "script" == a ? (a = '<script src="' + w(b) + '" type="text/javascript"',
                (d = y()) && (a += ' nonce="' + w(d) + '"'),
                document.write(a + ">\x3c/script>")) : "css" == a && (a = '<link href="' + w(b) + '" type="text/css" rel="stylesheet"',
                (d = y()) && (a += ' nonce="' + w(d) + '"'),
        ...
        google.loader.aa = function(a) {
            if ((a = a.specs) && a.length)
                for (var b = 0; b < a.length; ++b) {
                    var c = a[b];
                    "string" == typeof c ? H[":" + c] = new P(c) : (c = new Q(c.name,c.baseSpec,c.customSpecs),
                    H[":" + c.name] = c)
                }
        }
        ;
        ...
        P.prototype.load = function(a, b) {
            ...
            for (var f = [], h = d.length - 1; 0 <= h; h--) {
                var k = d[h];
                e && c.R(k);
                this.l[":" + k] ? (d.splice(h, 1),
                e && this.g[":" + k].push(c)) : f.push(k)
            }
            if (d.length) {
                ...
                if (b || null == I[":" + this.b] || null == I[":" + this.b].versions[":" + a] || google.loader.AdditionalParams || !this.s)
                    b && b.autoloaded || google.loader.f("script", this.i(a, b), e);
                else {
                    a = I[":" + this.b];
        ...
        P.prototype.o = function(a) {
            -1 != this.c && (S("al_" + this.b, "jl." + ((new Date).getTime() - this.c), !0),
            this.c = -1);
        ...
        var U = !1
          ...
          , S = function(a, b, c) {
            c ? Z([a], [b]) : (X(),
            V.push("r" + V.length + "=" + encodeURIComponent(a + (b ? "|" + b : ""))),
